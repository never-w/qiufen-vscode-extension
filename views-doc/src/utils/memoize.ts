...
export function memoize3<F extends (a1: any, a2: any, a3: any) => any>(
  fn: F,
): F {
...
export function memoize4<F extends (a1: any, a2: any, a3: any, a4: any) => any>(
  fn: F,
): F {
...
>(fn: F): F {
  const memoize2of4cache: WeakMap<
    Record<string, any>,
    WeakMap<Record<string, any>, any>
  > = new WeakMap()
